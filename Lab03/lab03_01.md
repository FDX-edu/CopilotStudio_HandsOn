...
8. 오른쪽 상단 메뉴에서 **초안 저장**을 클릭하여 저장합니다. 저장 후에 그 옆의 테스트를 클릭합니다. 
...
12. **+**를 클릭하여 **메시지 보내기** 를 선택하여 메시지 노드를 추가하고, **+ 추가**를 클릭하여 **적응형 카드**를 선택합니다.
...
13. 토픽을 저장하고, 테스트 합니다.
    ...
    ![image](https://github.com/user-attachments/assets/cd632604-d276-497d-a46c-d338ee7c81ae)
