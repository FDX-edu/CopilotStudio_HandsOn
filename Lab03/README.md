# Build and call Power Automate cloud flows 
...
- Copilot Studio를 사용하여 기본 사용 사례(ServiceNow 커넥터 사용)에서 Power Automate를 사용하여 다른 데이터 소스에서 데이터를 요청하고 고객 또는 사용자와의 대화형 대화에서 데이터를 반환합니다.
