...
5. **이 작업을 사용할 때를 아는 에이전트에 대한 설명**에 **한글로 대답합니다**를 추가합니다.
   ...
   **최종 사용자 인증**에서 **Copilot 작성자 인증**( Copilot author authentication)을 선택합니다. </br>
   ...
   ![image](https://github.com/user-attachments/assets/0ab1b305-aa06-4e51-9db2-e32d54b86ebe)


7. **입력 및 출력**을 선택합니다. </br>
   위치(Location) 속성은 그대로 두고 **단위(Units)** 속성을 선택합니다.

   ![image](https://github.com/user-attachments/assets/ed274800-c5b8-4438-aa0c-4e9581df09b6)
